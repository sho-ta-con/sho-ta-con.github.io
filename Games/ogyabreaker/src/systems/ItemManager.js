export default class ItemManager {
    constructor(scene) {
        ...
        this.itemTypes = [
            { type: 'life', chance: 0.04, char: '❤', color: '#ff6666', frame: 'life' },
            { type: 'bad_life', chance: 0.04, char: '❤', color: '#003366', frame: 'bad_life' },
            { type: 'penetrate', chance: 0.04, char: '✦', color: '#ffffff', frame: 'penetrate' },
            { type: 'split', chance: 0.04, char: '●', color: '#ffee66', frame: 'split' },
            { type: 'enlarge', chance: 0.04, char: '▬', color: '#ffffff', frame: 'enlarge' }
        ];
