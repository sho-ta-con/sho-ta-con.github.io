export class GameOver extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(384, 384, 'Game Over', {
        ...
        // Display final score
        this.add.text(384, 460, 'Score: ' + (this.finalScore || 0), {
        ...
        // Restart button
        const restartText = this.add.text(384, 540, 'Restart', {
        ...
        // Display gameover image if loaded
        try {
            if (this.textures && this.textures.exists && this.textures.exists('gameover')) {
                const img = this.add.image(384, 170, 'gameover').setOrigin(0.5).setDepth(400);
                try {
