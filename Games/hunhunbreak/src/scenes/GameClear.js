export class GameClear extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(512, 340, 'Game Clear', {
            fontFamily: 'Arial Black', fontSize: 64, color: '#ffffff',
            stroke: '#000000', strokeThickness: 8,
            align: 'center'
        }).setOrigin(0.5);

        this.add.text(512, 420, 'Score: ' + (this.finalScore || 0), {
        ...
        const restartText = this.add.text(512, 500, 'Restart', {
        ...
        // Display hunhun image if loaded
        try {
            if (this.textures && this.textures.exists && this.textures.exists('hunhun')) {
                const img = this.add.image(512, 165, 'hunhun').setOrigin(0.5).setDepth(400);
                try {
